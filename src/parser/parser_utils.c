...
TypeKind get_primitive_type_kind(const char *name)
{
    ...
    if (strcmp(name, "int") == 0 || strcmp(name, "i32") == 0 || strcmp(name, "int32_t") == 0) return TYPE_I32;
    if (strcmp(name, "u8") == 0 || strcmp(name, "uint8_t") == 0 || strcmp(name, "byte") == 0) return TYPE_U8;
    if (strcmp(name, "i8") == 0 || strcmp(name, "int8_t") == 0 || strcmp(name, "char") == 0) return TYPE_I8;
    if (strcmp(name, "i16") == 0 || strcmp(name, "short") == 0 || strcmp(name, "int16_t") == 0) return TYPE_I16;
    if (strcmp(name, "u16") == 0 || strcmp(name, "ushort") == 0 || strcmp(name, "uint16_t") == 0) return TYPE_U16;
    if (strcmp(name, "u32") == 0 || strcmp(name, "uint") == 0 || strcmp(name, "uint32_t") == 0) return TYPE_U32;
    if (strcmp(name, "i64") == 0 || strcmp(name, "long") == 0 || strcmp(name, "int64_t") == 0) return TYPE_I64;
    if (strcmp(name, "u64") == 0 || strcmp(name, "ulong") == 0 || strcmp(name, "uint64_t") == 0) return TYPE_U64;
    if (strcmp(name, "f32") == 0 || strcmp(name, "float") == 0) return TYPE_F32;
    if (strcmp(name, "f64") == 0 || strcmp(name, "double") == 0) return TYPE_F64;
    if (strcmp(name, "void") == 0) return TYPE_VOID;
    if (strcmp(name, "bool") == 0) return TYPE_BOOL;
    if (strcmp(name, "usize") == 0 || strcmp(name, "size_t") == 0) return TYPE_USIZE;
    if (strcmp(name, "isize") == 0 || strcmp(name, "ptrdiff_t") == 0) return TYPE_ISIZE;
